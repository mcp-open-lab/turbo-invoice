...
test.describe("Receipt Upload Flow", () => {
  ...
  test.skip("should upload single receipt via quick actions", async ({ page }) => {
  ...
  test.skip("should upload receipt via camera on mobile", async ({ page, isMobile }) => {
    // TODO: Implement E2E test
  ...
  test.skip("should extract receipt data correctly", async ({ page }) => {
    // TODO: Implement E2E test
  ...
  test.skip("should handle extraction errors gracefully", async ({ page }) => {
    // TODO: Implement E2E test
  ...
  test.skip("should allow editing extracted receipt data", async ({ page }) => {
    // TODO: Implement E2E test
